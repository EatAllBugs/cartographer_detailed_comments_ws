...
/**
 * @brief Construct a new Collated Trajectory Builder:: Collated Trajectory
 * Builder object
 *
...
void CollatedTrajectoryBuilder::HandleCollatedSensorData(
  ...
  // 也就是跑carto时候的消息：
  // [ INFO]: collated_trajectory_builder.cc:72] imu rate: 10.00 Hz 1.00e-01 s
  // +/- 4.35e-05 s (pulsed at 100.44% real time)
  // [ INFO]: collated_trajectory_builder.cc:72] scan rate: 19.83 Hz 5.04e-02 s
  // +/- 4.27e-05 s (pulsed at 99.82% real time)
